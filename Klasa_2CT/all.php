...
<div class="counter">
    <?php 
     $counter_records = $conn->query("SELECT COUNT(ksi____ka.ID) as 'ile' from ksi____ka;");
...
<div class="all"><ul>
<?php  
$all_records = $conn->query("SELECT ksi____ka.ID,ksi____ka.IMIE,ksi____ka.NAZWISKO,ksi____ka.WIEK from ksi____ka;");
