...
<h2>Autor: ja</h2>  
    ...
    <div class="counter">
    <?php 
     $counter_records = $conn->query("SELECT COUNT(ksi____ka.ID) as 'ile' from ksi____ka where WIEK between 10 and 18;");
   ...
   ?>
    ...
    <div class="osoby10_18"><ul>
<?php  
$all_records = $conn->query("SELECT ksi____ka.ID,ksi____ka.IMIE,ksi____ka.NAZWISKO,ksi____ka.WIEK from ksi____ka where WIEK between 10 and 18;");
